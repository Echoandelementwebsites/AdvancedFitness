...
const Services = () => {
    ...
    return (
        <section id="services" className="py-24 bg-secondary text-white relative overflow-hidden">
            {/* Background Texture */}
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <div key={index} className="group relative bg-zinc-900 border border-white/5 rounded-none overflow-hidden hover:border-primary/50 transition-all duration-300">
                            {/* Glow Effect */}
                            ...
                            <div className="relative z-10 h-full flex flex-col">
                                {service.image ? (
                                    ...
                                    <div className="h-64 bg-zinc-800 flex items-center justify-center border-b border-white/5 group-hover:border-primary/50 transition-colors">
                                        <span className="text-6xl group-hover:scale-110 transition-transform duration-300">⚡</span>
                                    </div>
                                )}
                                <div className="p-8 bg-zinc-900 group-hover:bg-black/90 transition-colors flex-grow">
                                    <h3 className="text-2xl font-heading font-bold mb-4 uppercase italic">{service.title}</h3>
