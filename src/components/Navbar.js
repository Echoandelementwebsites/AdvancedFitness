        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <ul className="hidden md:flex space-x-8 font-heading uppercase tracking-wide text-sm font-medium text-gray-700">
                    ...
                    <li><a href="#schedule" className="hover:text-primary transition-colors duration-300">Classes</a></li>
                    <li><a href="#contact" className="hover:text-primary transition-colors duration-300">Contact</a></li>
                </ul>
                <div className="hidden md:flex items-center space-x-4">
                    <a
                        href="https://wa.me/1234567890?text=Hi!%20I'm%20interested%20in%20your%20classes."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-[#25D366] hover:bg-[#128C7E] text-white font-medium py-2 px-4 rounded-full transition-colors duration-300 flex items-center shadow-md hover:shadow-lg"
                    >
            ...
            {isOpen && (
                <div className="md:hidden bg-white border-t border-gray-100">
                    <ul className="flex flex-col p-4 space-y-4 font-heading uppercase tracking-wide text-sm font-medium text-gray-900">
                        ...
                        <li><a href="#schedule" className="block hover:text-primary transition-colors duration-300" onClick={() => setIsOpen(false)}>Classes</a></li>
                        ...
                        <li className="mt-4">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center bg-[#25D366] hover:bg-[#128C7E] text-white font-medium py-3 px-4 rounded-md transition-colors duration-300 shadow-sm"
