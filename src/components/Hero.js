...
const Hero = () => {
    return (
        <section className="relative min-h-screen bg-white text-gray-900 overflow-hidden flex items-center pt-20 md:pt-0">
            ...
            <div className="container mx-auto px-4 h-full relative z-10">
                <div className="grid md:grid-cols-2 gap-12 items-center h-full">
                    ...
                    <div className="flex flex-col justify-center text-left py-12 md:py-0 order-2 md:order-1">
                        <div className="inline-block px-3 py-1 mb-6 border-l-4 border-primary bg-gray-50 backdrop-blur-sm w-fit">
                            <span className="text-primary font-heading uppercase tracking-widest text-sm font-bold">Nairobi's Premier Gym</span>
                        </div>

                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold text-gray-900 mb-6 uppercase tracking-tight leading-none">
                            TRANSFORM <br/>
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-rose-600">YOUR BODY</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-lg font-light leading-relaxed">
                        ...
                        {/* Trust Indicators */}
                        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-wrap gap-4 text-gray-500 text-sm font-heading uppercase tracking-wide">
